...
<body>
    <nav class="navbar navbar-light bg-light">
      ...
      <div class="container mt-5">
        ...
        <div class="mb-3 row">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" name="nama_siswa" class="form-control" id="nama" placeholder="ex: Danar" value="<?php echo $nama_siswa; ?>">
            </div>
            </div>
            <div class="mb-3 row">
              <label for="nama" class="col-sm-2 col-form-label">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-10">
        <input <?php if(!isset($_GET['ubah'])){ echo "required";}?> class="form-control" type="file" name="foto_siswa" id="foto" accept="image/*">
        </div>
        </div>
        <div class="mb-3 row">
